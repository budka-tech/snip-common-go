...
type EndpointClient interface {
	...
	UnregisterBucket(ctx context.Context, in *UnregisterBucketRequest, opts ...grpc.CallOption) (*common.Response, error)
	...
	DeleteImage(ctx context.Context, in *DeleteImageRequest, opts ...grpc.CallOption) (*common.Response, error)
...
func (c *endpointClient) UnregisterBucket(ctx context.Context, in *UnregisterBucketRequest, opts ...grpc.CallOption) (*common.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *endpointClient) DeleteImage(ctx context.Context, in *DeleteImageRequest, opts ...grpc.CallOption) (*common.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Response)
...
type EndpointServer interface {
	...
	UnregisterBucket(context.Context, *UnregisterBucketRequest) (*common.Response, error)
	...
	DeleteImage(context.Context, *DeleteImageRequest) (*common.Response, error)
...
func (UnimplementedEndpointServer) UnregisterBucket(context.Context, *UnregisterBucketRequest) (*common.Response, error) {
...
func (UnimplementedEndpointServer) DeleteImage(context.Context, *DeleteImageRequest) (*common.Response, error) {
