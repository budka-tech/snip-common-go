...
var file_gsm_gsm_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x73, 0x32, 0x7d, 0x0a, 0x03, 0x53, 0x6d, 0x73, 0x12, 0x31, 0x0a, 0x06, 0x47,
	...
	0x6e, 0x73, 0x65, 0x42, 0x11, 0x5a, 0x0f, 0x73, 0x74, 0x64, 0x65, 0x76, 0x2e, 0x67, 0x73, 0x6d,
...
var file_gsm_gsm_proto_depIdxs = []int32{
	0, // 0: gsm.Sms.GetSms:input_type -> gsm.GetSmsRequest
	2, // 1: gsm.Sms.GetFlashCall:input_type -> gsm.GetFlashCallRequest
	1, // 2: gsm.Sms.GetSms:output_type -> gsm.GetSmsResponse
	3, // 3: gsm.Sms.GetFlashCall:output_type -> gsm.GetFlashCallResponse
